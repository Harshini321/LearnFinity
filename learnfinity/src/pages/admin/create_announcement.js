...
export default function New_ann(props) {
    ...
    async function postAnn() {
        await addAnn()
        // console.log(staticFilesArr)
        // alert("staticFiles is", course_id)
        await axios
            .post("http://10.17.6.4//announcement", {
                "title": newTitle,
                "body": newAnn,
                "course_id": course_id,
                ...
                <div class="row">
                    ...
                    <div className='col-9 vertical-center1'>
                        <div class="card">
                            <div class="card-body">
                                <div className='form'>
                                    <h3 className='text-center'>Add New Announcement</h3>
                                    <form>
                                        ...
                                        <Form.Group className='text-center my-3'>
                                            <Button as="sub" variant="primary" className="btn btn-primary sub-btn btn-block my-3" onClick={postAnn} >Post</Button>
                                        </Form.Group>
                                    </form>
                                </div>
                            </div>
