...
def test_signin():
    ...
    assert json.loads(response.content) == {"access_token":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImNzMTIxMDA2OUBpaXRiLmFjLmluIn0.X1cKdnsp7RBo2w-y3omKl3D19m7I0VH29GfDu4HPwqw","email": "cs1210069@iitb.ac.in", "message": "User logged in successfully", "status_code": 200}
